...
TestWindow::TestWindow(SubWindowHost &host,const UserPreference &pref_)
 : ComboWindow(host),
   ...
   btn(wlist,pref.getButtonConfig(),String("Push")),
   ...
   label1(wlist,pref.getLabelConfig(),String("Red"),AlignX_Left),
   label2(wlist,pref.getLabelConfig(),String("Green"),AlignX_Left),
   label3(wlist,pref.getLabelConfig(),String("Blue"),AlignX_Left),
   label(wlist,pref.getLabelConfig(),String("On/Off"),AlignX_Left),
   text(wlist,pref.getTextConfig(),String("<none>")),
