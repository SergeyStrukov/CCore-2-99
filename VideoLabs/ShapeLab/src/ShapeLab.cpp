...
void TestDialog::layout()
 {
  ...
  radio_y_Top.setPlace(Pane({Coord(20+d),35},20));
  radio_y_Center.setPlace(Pane({Coord(20+d),60},20));
  radio_y_Bottom.setPlace(Pane({Coord(20+d),85},20));
  radio_y_Given.setPlace(Pane({Coord(20+d),110},20));
