...
class ShapeLab1 : public SubWindow
 {
     ...
     explicit Config(FontBuilder &fb)
      {
       ...
       label_cfg.font=fb.build_or_default("Georgia",18);
       btn_cfg.font=fb.build_or_default("Georgia"|Italic,20);
       text_cfg.font=fb.build_or_default("Times New Roman"|Italic,24);
       text_contour_cfg.font=fb.build_or_default("Georgia"|Italic,30);
      }
    };
  ...
  public:
   ...
   ShapeLab1(SubWindowHost &host,const Config &cfg);
...
class TestDialog : public SubWindow
 {
  ...
  public:
   ...
   TestDialog(SubWindowHost &host,const Config &cfg);
